...
So far we dealt with spectral peculiarities that are directly observable from the acquired spectra. In the case of multiple stellar systems, that might not be always true. As all of stars in a given system contribute to light received by the observer, the object must be treated as multiple to properly determine physical properties and abundances of an individual component. But to get the identification that object must be treated as multiple a single spectrum might not be enough as it does not reveal dynamics of the components. In this chapter, we show a possible way to identify and characterize multiple objects using data-driven machine learning approaches. We first focused on solar twin stars whose importance is given in Section \ref{sec:intro_solar} and their selection among the \Gh\ spectra described in Section \ref{sec:05_selection}. Their homogeneity of chemical composition (important for chemical tagging) is given Section \ref{sec:05_chem_compos}. 
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{sinlg_multi_sim_b3_50_50.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{three_stars_fit_sim_res.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{150408004101169_p1884_init_3.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{150408004101169_p1884_lnprob_3star_0.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{sinlg_multi_sim_b3_66_6_33_3.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{two_stars_fit_sim_res.png}
