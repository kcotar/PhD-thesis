...
For a tidal tail chemical tagging procedure, we used the same selection principle as previously described in Section \ref{sec:chem_ej_tag}. The results of the tagging experiment are presented in the last column of Table \ref{tab:cluster_stats_tails}. \rb{\ldots se manjka par stavkov }
...
% TODO To je tema, ki bi jo imelo smisel malo poglobiti. A lahko vidiš kak vzorec teh kalibracij vs. [Fe/H] ali vs. absolutna kemična zastopanost posameznega elementa? Človek bi upal, da gre za gladko progresijo, saj se pogovarjamo o zvezdi, ki je podobna, le kemija se ji spremeni. Seveda pa je tu treba vzeti recimo le glavno vejo, ne orjakinj, ali vsaj te posebej. Morda bi se splačalo tudi pogledat, ali obstaja kak trend s starostjo kopice (zvezde pri dani temperaturi so bližje MS, če so mlajše). Skratka, za te trende bi bilo fino ugotoviti neko zakonitost. Kopice so idealne, ker (upaš) obstaja vsaj določena kemična  homogenost. Obratno pa potem primerjaš še progresijo za različne elemente v dani kopici. Če se en obnaša čisto čudno, je bil a-priori slabo izmerjen (recimo iz črte, ki je kontaminirana z drugim elementom), ali pa morda ravno to kaže na intrinzično nehomogenost kopice. Skratka, jaz bi te razultate še malo ovrednotil, že zato, ker je to novo in uporabno tudi za druge. 