...
\usepackage[main=english,slovene]{babel}    
...
\usepackage{rotating}   % rotirana tabela
\usepackage{dirtytalk}  % narekovaji
...
\newcommand{\Xfe}{$\mathrm{[X/Fe]}$}
\newcommand{\Life}{$\mathrm{[Li/Fe]}$}
...
\hypersetup{pdfauthor={Klemen \v{C}otar},
			pdftitle={Understanding of open stellar clusters and peculiar spectra in sky surveys using machine learning},
			pdfsubject={Physics},
			pdfkeywords={methods: data analysis -- open clusters and associations: general -- Galaxy: stellar content -- stars: abundances -- stars: kinematics and dynamics -- binaries: general -- stars: peculiar -- stars: carbon -- stars: activity -- stars: emission-line -- stars: solar-type -- line: profiles -- catalogues},
